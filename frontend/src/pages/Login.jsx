    ...
    <div className="min-h-screen flex">
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={submit} className="mt-8 space-y-4">
            ...
            <Button type="submit" disabled={loading} data-testid="login-submit" className="w-full h-11 bg-brand-gradient text-white hover:opacity-90 font-semibold shadow-sm shadow-blue-500/20">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 text-white items-center justify-center p-10 relative overflow-hidden">
        ...
        <div className="relative max-w-md">
          ...
          <p className="text-sm font-semibold uppercase tracking-widest text-sky-300">For freelancers who care</p>
          ...
          <div className="mt-6 flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center font-bold">AK</div>
            <div>
