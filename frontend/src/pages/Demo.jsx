...
import {
  Users, FileText, Receipt, ArrowRight,
    ...
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground text-lg">
          ...
          professionally. No signup needed to explore.
        </p>
      </div>
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <div>
                    ...
                    <span className="font-medium">
                      {b.revisionsUsed}/{b.revisionsAllowed} used
                    </span>
                  </div>
                  <div>
          ...
          <table className="w-full text-sm">
            <thead className="bg-muted/50">
              <tr>
                ...
                <th className="text-left px-4 py-3 font-medium text-muted-foreground hidden md:table-cell">Advance</th>
            ...
            <tbody>
              {DEMO_INVOICES.map((inv, i) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 hidden sm:table-cell">{inv.clientName}</td>
                  <td className="px-4 py-3 font-medium">
                    ₹{inv.amount.toLocaleString("en-IN")}
                  </td>
                  <td className="px-4 py-3 text-muted-foreground hidden md:table-cell">
                    ₹{inv.advancePaid.toLocaleString("en-IN")}
                  </td>
                  <td className="px-4 py-3 text-muted-foreground hidden md:table-cell">
                    {inv.dueDate}
                  </td>
      ...
      <div className="rounded-2xl bg-gradient-to-br from-blue-600 to-violet-600 text-white p-8 text-center">
        ...
        <p className="text-blue-100 mb-6 max-w-lg mx-auto">
          GigVorx is free to start. Set up your first client workflow in under
          5 minutes.
        </p>
